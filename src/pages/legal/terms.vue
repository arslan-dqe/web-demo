      ...
      <main class="flex-1 min-w-0 max-w-3xl">
        ...
        >
          ...
          <div class="prose-legal">
            <p>
              By creating an account, accessing, or using the Service in any way, you ("Customer", "you") agree to be bound by these Terms and all policies incorporated herein by reference, including the <a
                href="/legal/privacy"
                class="text-blue-600 hover:underline"
              >Privacy Policy</a>. If you are entering into these Terms on behalf of a company or other legal entity, you represent that you have the authority to bind such entity to these Terms.
            </p>
            ...
            <dl class="space-y-3">
              <div class="grid grid-cols-[160px_1fr] gap-4 py-2.5 border-b border-slate-100">
                ...
                <dd class="text-sm text-slate-600 leading-relaxed">
                  The registered account you create to access the Service.
                </dd>
              </div>
              <div class="grid grid-cols-[160px_1fr] gap-4 py-2.5 border-b border-slate-100">
                <dt class="font-semibold text-slate-700 text-sm">
                ...
                <dd class="text-sm text-slate-600 leading-relaxed">
                  The DQE application programming interface, endpoints, and associated developer tools.
                </dd>
              </div>
              <div class="grid grid-cols-[160px_1fr] gap-4 py-2.5 border-b border-slate-100">
                <dt class="font-semibold text-slate-700 text-sm">
                ...
                <dd class="text-sm text-slate-600 leading-relaxed">
                  The unit of consumption for the Service. One Credit equals one validation query (address, email, or phone) regardless of channel.
                </dd>
              </div>
              <div class="grid grid-cols-[160px_1fr] gap-4 py-2.5 border-b border-slate-100">
                <dt class="font-semibold text-slate-700 text-sm">
                ...
                <dd class="text-sm text-slate-600 leading-relaxed">
                  Any data submitted by you to the Service for the purpose of validation, including addresses, email addresses, and phone numbers.
                </dd>
              </div>
              <div class="grid grid-cols-[160px_1fr] gap-4 py-2.5 border-b border-slate-100">
                <dt class="font-semibold text-slate-700 text-sm">
                ...
                <dd class="text-sm text-slate-600 leading-relaxed">
                  The results returned by the Service in response to a validation query, including standardized addresses, validation statuses, and appended data fields.
                </dd>
              </div>
              <div class="grid grid-cols-[160px_1fr] gap-4 py-2.5 border-b border-slate-100">
                <dt class="font-semibold text-slate-700 text-sm">
                ...
                <dd class="text-sm text-slate-600 leading-relaxed">
                  The no-cost, limited access to the Service comprising 100 Credits granted upon account creation, subject to Section 7.
                </dd>
              </div>
              <div class="grid grid-cols-[160px_1fr] gap-4 py-2.5 border-b border-slate-100">
                <dt class="font-semibold text-slate-700 text-sm">
                ...
                <dd class="text-sm text-slate-600 leading-relaxed">
                  A paid tier of the Service (currently "Verify" or "Advanced") selected by the Customer.
                </dd>
              </div>
              <div class="grid grid-cols-[160px_1fr] gap-4 py-2.5">
                ...
                <dd class="text-sm text-slate-600 leading-relaxed">
                  United States Postal Service address data incorporated into the Service under a USPS license.
                </dd>
              </div>
            </dl>
          </div>
        ...
        >
          ...
          <div class="prose-legal">
            <p>
              <strong>API keys.</strong> You are responsible for maintaining the confidentiality of your API key(s). Do not share, expose, or commit your API key in public repositories. You are liable for all API calls made using your key. Report suspected key compromise to <a
                href="mailto:security@dqe.io"
                class="text-blue-600 hover:underline"
              >security@dqe.io</a> immediately.
            </p>
        ...
        >
          ...
          <div class="prose-legal">
            <p>
              <strong>Informal resolution.</strong> Before initiating arbitration or litigation, you agree to contact DQE at <a
                href="mailto:legal@dqe.io"
                class="text-blue-600 hover:underline"
              >legal@dqe.io</a> and attempt to resolve any dispute informally. DQE will similarly contact you using your Account email. If the dispute is not resolved within 30 days of initial notice, either party may proceed to arbitration.
            </p>
            ...
            <p>
              <strong>Opt-out.</strong> You may opt out of the binding arbitration and class-action waiver provisions by sending written notice to <a
                href="mailto:legal@dqe.io"
                class="text-blue-600 hover:underline"
              >legal@dqe.io</a> within <strong>30 days</strong> of first creating your Account. Your opt-out notice must include your name, Account email, and a clear statement that you wish to opt out of arbitration.
            </p>
          </div>
        </section>
