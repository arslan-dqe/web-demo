    ...
    >
      <div class="max-w-7xl mx-auto px-6 h-14 flex items-center gap-6">
        ...
        <div class="ml-auto flex items-center gap-4">
          <a href="/legal/terms" class="text-sm text-slate-500 hover:text-blue-600 transition-colors">Terms of Use</a>
    ...
    <div class="max-w-7xl mx-auto px-6 pt-24 pb-20 flex gap-12">
      ...
      <main class="flex-1 min-w-0 max-w-3xl">
        ...
        <div class="mb-12 pb-8 border-b border-slate-100">
          ...
          <h1 class="text-4xl font-bold text-slate-900 tracking-tight mb-3">Privacy Policy</h1>
        ...
        <!-- §1 Who We Are -->
        <section id="intro" class="mb-10 scroll-mt-24">
          <h2 class="text-xl font-bold text-slate-900 mb-4">1. Who We Are</h2>
          <div class="prose-legal">
            ...
            <div class="bg-slate-50 border border-slate-200 rounded px-5 py-4 text-sm text-slate-700 space-y-1 mt-3">
              ...
              <p>Data protection contact: <a href="mailto:privacy@dqe.io" class="text-blue-600 hover:underline">privacy@dqe.io</a></p>
            </div>
          </div>
        </section>

        <!-- §2 Data We Collect -->
        <section id="collected" class="mb-10 scroll-mt-24">
          <h2 class="text-xl font-bold text-slate-900 mb-4">2. Data We Collect</h2>
          <div class="prose-legal">

            <h3 class="text-base font-semibold text-slate-800 mb-2 mt-5">2.1 Account & Registration Data</h3>
            ...
            <h3 class="text-base font-semibold text-slate-800 mb-2 mt-5">2.2 Billing & Payment Data</h3>
            ...
            <h3 class="text-base font-semibold text-slate-800 mb-2 mt-5">2.3 API Usage & Log Data</h3>
            ...
            <h3 class="text-base font-semibold text-slate-800 mb-2 mt-5">2.4 Customer Validation Data</h3>
            ...
            <h3 class="text-base font-semibold text-slate-800 mb-2 mt-5">2.5 Website & Cookie Data</h3>
            ...
            <h3 class="text-base font-semibold text-slate-800 mb-2 mt-5">2.6 Communications</h3>
        ...
        <!-- §3 How We Use Data -->
        <section id="how-we-use" class="mb-10 scroll-mt-24">
          <h2 class="text-xl font-bold text-slate-900 mb-4">3. How We Use Your Data</h2>
          <div class="prose-legal">
        ...
        <!-- §4 Legal Bases -->
        <section id="legal-bases" class="mb-10 scroll-mt-24">
          <h2 class="text-xl font-bold text-slate-900 mb-4">4. Legal Bases for Processing (GDPR)</h2>
          <div class="prose-legal">
            ...
            <div class="space-y-3 mt-2">
              <div class="grid grid-cols-[180px_1fr] gap-4 py-2.5 border-b border-slate-100">
                <dt class="font-semibold text-slate-700 text-sm">Contract performance</dt>
                <dd class="text-sm text-slate-600 leading-relaxed">Processing necessary to create and maintain your Account, deliver API results, and fulfil paid subscription obligations (Art. 6(1)(b) GDPR).</dd>
              </div>
              <div class="grid grid-cols-[180px_1fr] gap-4 py-2.5 border-b border-slate-100">
                <dt class="font-semibold text-slate-700 text-sm">Legitimate interests</dt>
                <dd class="text-sm text-slate-600 leading-relaxed">Fraud prevention, security monitoring, improving the Service, and business communications where our interests are not overridden by your rights (Art. 6(1)(f) GDPR).</dd>
              </div>
              <div class="grid grid-cols-[180px_1fr] gap-4 py-2.5 border-b border-slate-100">
                <dt class="font-semibold text-slate-700 text-sm">Legal obligation</dt>
                <dd class="text-sm text-slate-600 leading-relaxed">Tax records, financial accounting, and responding to lawful requests from public authorities (Art. 6(1)(c) GDPR).</dd>
              </div>
              <div class="grid grid-cols-[180px_1fr] gap-4 py-2.5">
                <dt class="font-semibold text-slate-700 text-sm">Consent</dt>
                <dd class="text-sm text-slate-600 leading-relaxed">Marketing communications and non-essential cookies, where we have obtained your prior opt-in consent. You may withdraw consent at any time (Art. 6(1)(a) GDPR).</dd>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="sharing" class="mb-10 scroll-mt-24">
          <h2 class="text-xl font-bold text-slate-900 mb-4">5. Sharing & Subprocessors</h2>
          <div class="prose-legal">
            ...
            <h3 class="text-base font-semibold text-slate-800 mb-3 mt-6">Subprocessor list</h3>
            <div class="border border-slate-200 overflow-hidden rounded text-sm">
              <table class="w-full">
                <thead>
                  <tr class="bg-slate-50 border-b border-slate-200">
                    <th class="text-left px-4 py-2.5 font-mono text-[10px] text-slate-500 uppercase tracking-wider">Subprocessor</th>
                    <th class="text-left px-4 py-2.5 font-mono text-[10px] text-slate-500 uppercase tracking-wider">Purpose</th>
                    <th class="text-left px-4 py-2.5 font-mono text-[10px] text-slate-500 uppercase tracking-wider">Location</th>
                  </tr>
                </thead>
                <tbody>
                  <tr
                  ...
                  >
                    <td class="px-4 py-2.5 font-semibold text-slate-700">{{ sp.name }}</td>
                    <td class="px-4 py-2.5 text-slate-500">{{ sp.purpose }}</td>
                    <td class="px-4 py-2.5 text-slate-500 font-mono text-[11px]">{{ sp.location }}</td>
                  </tr>
                </tbody>
              </table>
            </div>
            <p class="text-xs text-slate-400 mt-2">This list is reviewed and updated at least annually. We will notify you of material changes to our subprocessors via email or in-app notice.</p>
          </div>
        </section>

        <!-- §6 Customer Validation Data -->
        <section id="validation-data" class="mb-10 scroll-mt-24">
          <h2 class="text-xl font-bold text-slate-900 mb-4">6. Customer Validation Data</h2>
          <div class="prose-legal">
            <div class="bg-emerald-50 border border-emerald-200 px-4 py-3 rounded text-sm text-emerald-800 mb-4 flex gap-2.5">
              <UIcon name="i-lucide-shield-check" class="w-4 h-4 text-emerald-500 flex-shrink-0 mt-0.5" />
            ...
            <p>Customer Validation Data is stored in encrypted form (AES-256 at rest, TLS 1.2+ in transit) and is automatically deleted <strong>30 days</strong> after processing is complete. You may request earlier deletion at any time by contacting <a href="mailto:privacy@dqe.io" class="text-blue-600 hover:underline">privacy@dqe.io</a> or using the delete function in your Account dashboard.</p>
          </div>
        </section>

        <!-- §7 Retention -->
        <section id="retention" class="mb-10 scroll-mt-24">
          <h2 class="text-xl font-bold text-slate-900 mb-4">7. Data Retention</h2>
          <div class="prose-legal">
            <div class="border border-slate-200 overflow-hidden rounded text-sm mt-2">
              <table class="w-full">
                <thead>
                  <tr class="bg-slate-50 border-b border-slate-200">
                    <th class="text-left px-4 py-2.5 font-mono text-[10px] text-slate-500 uppercase tracking-wider">Data type</th>
                    <th class="text-left px-4 py-2.5 font-mono text-[10px] text-slate-500 uppercase tracking-wider">Retention period</th>
                  </tr>
                </thead>
                <tbody class="divide-y divide-slate-100">
                  <tr class="bg-white">
                    <td class="px-4 py-3 font-semibold text-slate-700">Account registration data</td>
                    <td class="px-4 py-3 text-slate-500">Duration of account + 90 days after closure</td>
                  </tr>
                  <tr class="bg-slate-50/50">
                    <td class="px-4 py-3 font-semibold text-slate-700">Billing & payment records</td>
                    <td class="px-4 py-3 text-slate-500">7 years (tax & accounting legal requirement)</td>
                  </tr>
                  <tr class="bg-white">
                    <td class="px-4 py-3 font-semibold text-slate-700">Customer validation data</td>
                    <td class="px-4 py-3 text-slate-500">30 days post-processing, then permanently deleted</td>
                  </tr>
                  <tr class="bg-slate-50/50">
                    <td class="px-4 py-3 font-semibold text-slate-700">API usage logs</td>
                    <td class="px-4 py-3 text-slate-500">90 days (security & debugging)</td>
                  </tr>
                  <tr class="bg-white">
                    <td class="px-4 py-3 font-semibold text-slate-700">Support communications</td>
                    <td class="px-4 py-3 text-slate-500">2 years after ticket closure</td>
                  </tr>
                  <tr class="bg-slate-50/50">
                    <td class="px-4 py-3 font-semibold text-slate-700">Website analytics (anonymized)</td>
                    <td class="px-4 py-3 text-slate-500">26 months</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section id="cookies" class="mb-10 scroll-mt-24">
          <h2 class="text-xl font-bold text-slate-900 mb-4">8. Cookies & Tracking Technologies</h2>
          <div class="prose-legal">
            ...
            <div class="space-y-3 mt-3">
              <div class="border border-slate-200 rounded p-4">
                ...
                <p class="text-xs text-slate-500 leading-relaxed">Session management, authentication, CSRF protection, load balancing (Cloudflare). Required for the Service to function.</p>
              </div>
              <div class="border border-slate-200 rounded p-4">
                <div class="flex items-center gap-2 mb-1.5">
                ...
                <p class="text-xs text-slate-500 leading-relaxed">Google Analytics (anonymized IP). Helps us understand how visitors use the site so we can improve it. No personal data is shared with Google for advertising.</p>
              </div>
              <div class="border border-slate-200 rounded p-4">
                <div class="flex items-center gap-2 mb-1.5">
                ...
                <p class="text-xs text-slate-500 leading-relaxed">Used to measure the effectiveness of our advertising campaigns (Google Ads conversion tracking). Disabled by default; enabled only with your explicit consent.</p>
              </div>
            </div>
        ...
        <section id="transfers" class="mb-10 scroll-mt-24">
          <h2 class="text-xl font-bold text-slate-900 mb-4">9. International Data Transfers</h2>
          <div class="prose-legal">
            ...
            <p>Customers who require a Data Processing Addendum (DPA) for GDPR compliance may request one at <a href="mailto:privacy@dqe.io" class="text-blue-600 hover:underline">privacy@dqe.io</a>. We execute DPAs within five business days of a valid request.</p>
          </div>
        </section>

        <!-- §10 GDPR Rights -->
        <section id="gdpr-rights" class="mb-10 scroll-mt-24">
          <h2 class="text-xl font-bold text-slate-900 mb-4">10. Your Rights under GDPR / UK GDPR</h2>
          <div class="prose-legal">
            ...
            <div class="space-y-2 mt-3">
              ...
              >
                <UIcon name="i-lucide-check-circle" class="w-4 h-4 text-blue-500 flex-shrink-0 mt-0.5" />
                <div>
            ...
            <p class="mt-4">To exercise any of these rights, contact us at <a href="mailto:privacy@dqe.io" class="text-blue-600 hover:underline">privacy@dqe.io</a>. We will respond within <strong>30 days</strong> (extendable by a further 60 days for complex requests, with notice). Identity verification may be required before we act on a request.</p>
          </div>
        </section>

        <!-- §11 CCPA -->
        <section id="ccpa" class="mb-10 scroll-mt-24">
          <h2 class="text-xl font-bold text-slate-900 mb-4">11. California Privacy Rights (CCPA / CPRA)</h2>
          <div class="prose-legal">
            ...
            <p>Submit a verifiable consumer request by emailing <a href="mailto:privacy@dqe.io" class="text-blue-600 hover:underline">privacy@dqe.io</a> or calling <a href="tel:+18005550100" class="text-blue-600 hover:underline">1-800-555-0100</a>. We will respond within <strong>45 days</strong>.</p>
        ...
        <!-- §12 Security -->
        <section id="security" class="mb-10 scroll-mt-24">
          <h2 class="text-xl font-bold text-slate-900 mb-4">12. Security</h2>
          <div class="prose-legal">
            ...
            <p>No method of transmission over the Internet or electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your data, we cannot guarantee absolute security. Report suspected security issues to <a href="mailto:security@dqe.io" class="text-blue-600 hover:underline">security@dqe.io</a>.</p>
          </div>
        </section>

        <!-- §13 Children -->
        <section id="children" class="mb-10 scroll-mt-24">
          <h2 class="text-xl font-bold text-slate-900 mb-4">13. Children's Privacy</h2>
          <div class="prose-legal">
            <p>The Service is intended for use by businesses and professionals. We do not knowingly collect personal information from individuals under the age of 16. If you become aware that a child under 16 has provided us with personal data, please contact us at <a href="mailto:privacy@dqe.io" class="text-blue-600 hover:underline">privacy@dqe.io</a> and we will take steps to delete such information promptly.</p>
          </div>
        </section>

        <!-- §14 Changes -->
        <section id="changes" class="mb-10 scroll-mt-24">
          <h2 class="text-xl font-bold text-slate-900 mb-4">14. Changes to This Policy</h2>
          <div class="prose-legal">
        ...
        <section id="contact" class="mb-10 scroll-mt-24">
          <h2 class="text-xl font-bold text-slate-900 mb-4">15. Contact & Data Processing Addendum</h2>
          <div class="prose-legal">
            <p>For any privacy-related questions, data subject requests, DPA requests, or to report a concern:</p>
            <div class="bg-slate-50 border border-slate-200 rounded px-5 py-4 text-sm text-slate-700 space-y-1 mt-3">
              <p class="font-semibold text-slate-900">DQE USA — Privacy Team</p>
              <p>1200 Brickell Ave, Ste 1960</p>
              <p>Miami, FL 33131, United States</p>
              <p>Email: <a href="mailto:privacy@dqe.io" class="text-blue-600 hover:underline">privacy@dqe.io</a></p>
              <p>Security: <a href="mailto:security@dqe.io" class="text-blue-600 hover:underline">security@dqe.io</a></p>
            </div>
            <p class="mt-4">Enterprise customers requiring a signed <strong>Data Processing Addendum (DPA)</strong> including EU Standard Contractual Clauses may request one at <a href="mailto:privacy@dqe.io" class="text-blue-600 hover:underline">privacy@dqe.io</a>. We execute DPAs within five business days.</p>
          </div>
        </section>
        ...
        <div class="border-t border-slate-100 pt-8 flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
          ...
          <a href="/legal/terms" class="text-sm text-blue-600 hover:underline font-medium">
